INSERT INTO company (name, description, city, employees, telephone, email)
VALUES ('Appul', 'Jesteśmy innowacyjną firmą z tradycjami, tworzymy oprogramowanie od ponad 20 lat', 'Wrocław', 100,
...
INSERT INTO job_offer (title, description, requirements, duties, location, min_salary, max_salary, date_added,
                       submissions, company_id)
VALUES ('Senior java developer', 'Dołącz do naszego zespołu i twórz nowoczesne aplikacje',
